...
- **`channelNotAvailable`**
  ...
  - IT: Il canale {channel} non è aperto sul dispositivo audio corrente
  - [ ] OK    Fix: 
...
- **`snapshotOverwriteWarning`**
  ...
  - IT: Esiste già uno snapshot con questo nome — verrà sovrascritto.
  - [ ] OK    Fix: 
