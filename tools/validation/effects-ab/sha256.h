...
//==============================================================================
// Self-contained SHA-256 (FIPS 180-4). Copied verbatim from
// tools/validation/offline-render/sha256.h (which this harness must not edit), so
// the input fingerprint matches `sha256sum` and gen_input.py's, with no
// dependency on juce_cryptography (which the app project does not build).
//==============================================================================
